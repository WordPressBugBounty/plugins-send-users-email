                                    ...
                                    <table width="100%" style="border-spacing:0;" role="presentation">
                                        <tr>
                                            <td class="padding content"
                                                style="background-color:#04AA6D;padding-top:2px;padding-bottom:1px;padding-right:0;padding-left:0;width:100%;text-align:center; width:600px;"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="darkmode-bg" valign="top" align="center"
                                                                        ...
                                                                        <?php if ( $obj_template_data && $obj_template_data->get_email_tagline() ): ?>
                                                                            <p style="max-width: 150px;height: 2px;background-color:#04AA6D;border-top: 1px solid #ffffff;border-bottom: 1px solid #ffffff;line-height: 40px;"></p>
                ...
                <tr>
                    <td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;">
                        <table width="100%" style="border-spacing:0;" role="presentation">
                            <tr>
                                <td class="padding content"
                                    style="background-color:#04AA6D;padding-top:2px;padding-bottom:1px;padding-right:0;padding-left:0;width:100%;text-align:center; width:600px;">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" style="border-spacing:0;padding-top:5px" role="presentation">
                            <tr>
                                <td class="padding content sue-footer"
                                    style="background-color:#04AA6D;color:#ffffff;padding-top:30px;padding-bottom:30px;padding-right:0;padding-left:0;width:100%;text-align:center; width:600px;">
